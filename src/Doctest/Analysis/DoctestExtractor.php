 ...
 * @visibility public
 *
 * @example Extracting the examples an at-example tag introduces
 *     $extractor = new DoctestExtractor();
 *     $tagged = $extractor->tagExamples('@' . 'example Adding' . "\n" . 'add(1, 2)');
 *     count($tagged) // => 1
 *     $tagged[0]['code'] // => 'add(1, 2)'
 */
