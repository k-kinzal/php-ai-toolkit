...
final class VisibilityScopeResolverTest extends TestCase
{
    ...
    {
        self::assertFalse((new VisibilityScopeResolver())->resolve(null, 'App\\Domain')->isRestricted());
    }

    public function testResolveLeavesPublicDeclarationUnrestricted(): void
    {
        self::assertFalse((new VisibilityScopeResolver())->resolve('/** @visibility public */', 'App\\Domain')->isRestricted());
    }

    public function testResolveMarksATaggedDeclarationRestricted(): void
    {
        self::assertTrue((new VisibilityScopeResolver())->resolve('/** @visibility namespace */', 'App\\Domain')->isRestricted());
    }
    ...
    {
        self::assertFalse((new VisibilityScopeResolver())->resolve('/** @visibility parrent */', 'App\\Domain')->isRestricted());
    }

    public function testResolveLeavesUnusableScopeUnrestricted(): void
    {
        self::assertFalse((new VisibilityScopeResolver())->resolve('/** @visibility 123bad */', 'App\\Domain')->isRestricted());
    }
