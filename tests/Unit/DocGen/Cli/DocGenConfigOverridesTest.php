...
final class DocGenConfigOverridesTest extends TestCase
{
    public function testApplyOverridesOutputAndCoverage(): void
    {
        ...
        $arguments = ['config' => null, 'output' => 'public/docs', 'vendor' => null, 'vendorDev' => null, 'coverage' => 'build/coverage-xml', 'baseUrl' => null, 'serve' => null, 'memoryLimit' => null, 'jobs' => null, 'base' => null, 'head' => null, 'cacheDir' => null, 'noCache' => false, 'clearCache' => false, 'help' => false, 'version' => false];
    ...
    public function testApplyMergesVendorGlobsOntoConfiguredList(): void
    {
        ...
        $arguments = ['config' => null, 'output' => null, 'vendor' => ['cli/*', 'extra'], 'vendorDev' => null, 'coverage' => null, 'baseUrl' => null, 'serve' => null, 'memoryLimit' => null, 'jobs' => null, 'base' => null, 'head' => null, 'cacheDir' => null, 'noCache' => false, 'clearCache' => false, 'help' => false, 'version' => false];
    ...
    public function testApplyMergesVendorDevGlobsOntoConfiguredList(): void
    {
        ...
        $arguments = ['config' => null, 'output' => null, 'vendor' => null, 'vendorDev' => ['phpunit/*'], 'coverage' => null, 'baseUrl' => null, 'serve' => null, 'memoryLimit' => null, 'jobs' => null, 'base' => null, 'head' => null, 'cacheDir' => null, 'noCache' => false, 'clearCache' => false, 'help' => false, 'version' => false];
    ...
    {
        $config = new DocGenConfig('/tmp/project', ['.'], [], [], 'build/docs', null, null, null, [], 'build/doc-gen-cache');
        $arguments = ['config' => null, 'output' => null, 'vendor' => null, 'vendorDev' => null, 'coverage' => null, 'baseUrl' => null, 'serve' => null, 'memoryLimit' => null, 'jobs' => null, 'base' => null, 'head' => null, 'cacheDir' => null, 'noCache' => true, 'clearCache' => false, 'help' => false, 'version' => false];
