 ...
 *
 * A namespace behaves like a Rust module: it contains its own declarations and,
 * transitively, everything declared below it. Every scope this package resolves
 * is one namespace plus that subtree, so ancestry is the only arithmetic needed.
 */
final class NamespaceLineage
{
    /**
     * Returns the namespace part of a fully qualified name, empty for the global namespace.
     */
