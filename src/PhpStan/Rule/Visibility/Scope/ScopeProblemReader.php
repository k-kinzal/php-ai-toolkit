...
/**
 * Explains why an @visibility value cannot be enforced as written.
 */
final class ScopeProblemReader
{
    ...
    /**
     * Returns why a scope value cannot be enforced, or null when it can.
     */
    ...
    /**
     * Returns why parent cannot be enforced, or null when it can.
     */
    ...
    /**
     * Returns why a written namespace cannot be enforced, or null when it can.
     */
