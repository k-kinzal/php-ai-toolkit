...
/**
 * Resolves absolute and project-relative paths for doctest file scanning.
 *
 * @visibility parent
 */
final class DoctestPathResolver
{
    /**
    ...
    /**
     * Returns a path relative to the doctest project root when possible.
     */
