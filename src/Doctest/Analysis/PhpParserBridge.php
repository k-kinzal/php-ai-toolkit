...
final class PhpParserBridge
{
     ...
     *
     * @throws DoctestException when the parser factory exposes no supported creation method or produces no parser
     */
    public function parser(): Parser
    {
        ...
        try {
            ...
            throw new DoctestException('The installed nikic/php-parser version exposes no supported parser factory method.', 0, $exception);
        }

        if (!$created instanceof Parser) {
            throw new DoctestException('The installed nikic/php-parser version produced no parser instance.');
        }
